...
class Player:
    ...
    def actions(self, environment):
        ...
        # Request user to input desired action selection
        while True:
            choice = input("Please Enter Action #: ")
            # Check to see if player provided an acceptable input of 1, 2, 3, or 4
            if choice.isdigit():
                choice = int(choice)
        ...
        while not actionCompleted:
            ...
            # Reserve 1 development card and take 1 gold token (joker).
                ...
                if len(self.__reservedCards) < 3:
                    ...
                    print("You have 3 cards under your reservations")
